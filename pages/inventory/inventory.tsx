...
export default function Inventory() {
    return (
        <>
            <p className="text-4xl pt-24  new-rocker-regular text-white flex justify-center items-center">Purchased
                Tickets</p>
            <div className=" flex justify-center py-6 pb-24">
                <div
                    className="max-w-7xl p-6  bg-[#2e3239] bg-opacity-20 backdrop-blur-lg rounded-xl overflow-auto h-[70vh] 2xl:h-[60vh] "
                ...
                >
                    <div className=" grid grid-cols-1 gap-x-8 gap-y-8 sm:gap-y-20 lg:mx-0 lg:grid-cols-2">
                        {purchasedTickets.map((purchasedTickets, index) => (
                            <div key={index} className=" w-full rounded-xl p-5 ">
                                <div>
                                    <CardContainer>
                                        <CardBody>
                                ...
                                <div className="flex flex-col text-left">
                                    <p className="text-xl new-rocker-regular text-white items-center mt-4">
                                        Purchase date: {purchasedTickets.inventory.purchaseDate}
                                    </p>
                                    <p className="text-xl new-rocker-regular text-white items-center mt-4">
                                        Price: {purchasedTickets.inventory.price}
                                    </p>
                                    <p className="text-xl new-rocker-regular text-white items-center mt-4">
                                        Category: {purchasedTickets.inventory.category}
                                    </p>
                                </div>
                            </div>
                        ))}
