    ...
    const handleFormSubmit = async (event) => {
        ...
        if (token) {
            ...
            Object.keys(formData).forEach(key => {
                if (key === 'concert_photo' && formData[key]) {
            ...
            const response = await fetch("http://localhost:8000/api/admin/concerts", {
                method: 'POST',
                headers: {
    ...
    return (
        <>
            ...
            <div className=" w-2/3 text-white grid grid-cols-2 gap-4 p-10">
                <Link href="/admin/concerts/concertlists" legacyBehavior>
                    <div
                        ...
                        <div className="flex flex-col justify-center items-center">
                            <h1 className="text-4xl font-bold mb-5">Show List of Concerts</h1>
                            <p className="text-2xl text-second ">Total Registered Concerts: {concerts.length} Concerts </p>
                        </div>
                    </div>
                </Link>
                ...
                <div onClick={() => setModalIsOpen(true)}
                     className="border-2 bg-gray-800 p-10 rounded-lg cursor-pointer hover:bg-green-800 hover:scale-105 transition-all">
                    <div className="flex flex-col justify-center items-center">
                        <h1 className="text-4xl font-bold mb-5">Create New Concert</h1>
                        <a className="text-2xl text-second">Create a New Concert</a>
                    </div>
                </div>
                ...
                <Modal isOpen={modalIsOpen} onRequestClose={() => setModalIsOpen(false)}
                    ...
                    <h1 className={"text-prime text-center text-2xl text-yellow-300 "}>CREATE NEW CONCERT</h1>
