    ...
    return (
        ...
        <div className="h-screen w-full flex flex-col items-center justify-center">
            ...
            <div className="w-full p-4 absolute 2xl:top-48 xs:top-20 xl:top-32">
                ...
                <div
                    className="flex xs:flex-col lg:flex-row justify-center items-center space-y-5 px-16 xl:ml-20 xl:pl-20 2xl:pl-24 2xl:ml-24 ">
                    ...
                    <div className="w-full flex flex-col justify-center items-center">
                        <div className="z-10 text-center">
                            ...
                            <div
                                ...
                                <div>
                                    <span className="bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 xs:text-[1rem] xl:text-[3rem] 2xl:text-[4rem] drop-shadow-xl">We are ready to </span>
                                </div>
                                <div>
                                    <span className="bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent xs:text-[1rem] xl:text-[3rem]  2xl:text-[4rem] drop-shadow-xl">Tune in With You</span>
                                </div>
                            </div>
