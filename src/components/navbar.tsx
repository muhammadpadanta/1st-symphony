    ...
    import {BsMusicNoteBeamed, BsClipboard2Check, BsJustify, BsCart, BsPersonCircle} from "react-icons/bs";
                    ...
                    <div className="flex justify-between w-2/3 mx-auto items-center">
                        <div className="ml-5 flex items-center ">
                            ...
                            <Link href="/" legacyBehavior>
                                <div
                                    className="text-[#FFC107] font-bold text-lg flex justify-between xl:text-xl  hover:opacity-70 transition-all "> 1st
                                    Symphony
                                </div>
                            </Link>
                        </div>
                                        ...
                                        {checkUserLoggedIn() ? (
                                            ...
                                            <>
                                                <Link href="/auth/register" legacyBehavior>
                                                    <div
                                                        className="text-md text-[#FFC107] hover:scale-110 hover:text-[#8BC34A] transition-all cursor-pointer">
                                                        Sign Up
                                                    </div>
                                                </Link>
