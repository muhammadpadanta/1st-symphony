...
export const Menu = ({
  ...
  return (
    <nav
      ...
      className="w-screen top-0 sticky z-50 bg-[#051131] flex justify-between items-center px-8 py-6"
    >
      <div className="text-white flex justify-between dancing-script-font text-3xl ">1st Symphony</div> {/* Align to the left */}
