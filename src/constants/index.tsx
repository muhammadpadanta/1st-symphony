...
export const featuredArtist = [
  // --------------- row1 ---------------
  {
    title: "Justin Bieber",
    link: "",
    thumbnail: "/images/homeFeaturedArtist1.webp",
  },
  {
    title: "Yoasobi",
    link: "",
    thumbnail: "/images/homeFeaturedArtist2.webp",
  },
  {
    title: "Newjeans",
    link: "",
    thumbnail: "/images/homeFeaturedArtist3.webp",
  },

  {
    title: "Tulus",
    link: "",
    thumbnail: "/images/homeFeaturedArtist4.webp",
  },
  {
    title: "Blackpink",
    link: "",
    thumbnail: "/images/homeFeaturedArtist5.webp",
  },
  ...
  // --------------- row2 ---------------
  {
    title: "Twice",
    link: "",
    thumbnail: "/images/homeFeaturedArtist6.webp",
  },

  {
    title: "Imagine Dragons",
    link: "",
    thumbnail: "/images/homeFeaturedArtist7.webp",
  },
  {
    title: "Virgoun",
    link: "",
    thumbnail: "/images/homeFeaturedArtist8.webp",
  },
  {
    title: "Raisa",
    link: "",
    thumbnail: "/images/homeFeaturedArtist9.webp",
  },
  {
    title: "Armada",
    link: "",
    thumbnail: "/images/homeFeaturedArtist10.webp",
  },
  ...
  // --------------- row3 ---------------
  {
    title: "Coldplay",
    link: "",
    thumbnail: "/images/homeFeaturedArtist11.webp",
  },

  {
    title: "BTS",
    link: "",
    thumbnail: "/images/homeFeaturedArtist12.webp",
  },
  {
    title: "Charlie Puth",
    link: "",
    thumbnail: "/images/homeFeaturedArtist13.webp",
  },
  {
    title: "Mahalini",
    link: "",
    thumbnail: "/images/homeFeaturedArtist14.webp",
  },
  {
    title: "Tiara Andhini",
    link: "",
    thumbnail: "/images/homeFeaturedArtist15.webp",
  },
...
export const ticketFeatures = [
  {
    name: "Find By Artist",
    description: "Search Ticket by Finding your Favorite Artist.",
...
export const socialMedia = [
  ...
  },
  {
    ...
    image:
      "https://assets.dryicons.com/uploads/icon/svg/8312/cc33248a-e56e-4e7f-93f4-0e16350e5768.svg",
...
export const faqs = [
...

  {
    ...
    answer:
      "After you complete your ticket purchase on our website, you will receive a confirmation email with details about your order. Your concert concerts will be delivered to you electronically via email.",
  },

  {
    question: "Can I cancel my concert concerts after purchasing them?",
    answer:
      "Unfortunately, we are unable to offer cancellations or exchanges for concert concerts once they have been purchased.",
  },

  {
    question: "age restrictions for concerts listed on your website?",
    answer:
      "Age restrictions for concerts vary depending on the event and venue. Some concerts may be open to all ages, while others may have age restrictions imposed by the artist or venue.",
  },

  {
    question: "How do I know if my concert concerts are authentic?",
    answer:
      "When you purchase concerts through our website, you can rest assured that you are buying genuine concerts directly from authorized sellers.",
  },

  {
    question: "What payment methods do you accept?",
    answer:
      "We accept a variety of payment methods including credit/debit cards, PayPal, and other secure payment options to ensure your transaction is safe and convenient.",
  },
];
...
export const heroWords = [
  {
    ...
    className:
      "bg-clip-text text-transparent bg-gradient-to-b from-neutral-50 to-neutral-400 text-xl xl:text-[2rem] 2xl:text-[3rem] drop-shadow-xl",
  },

  {
    text: "Tune in with You.",
    className:
      "bg-gradient-to-r from-amber-500 to-pink-500 bg-clip-text text-transparent text-xl xl:text-[2rem]  2xl:text-[3rem] drop-shadow-xl",
  },
];
